...
namespace TrafficLedger.Desktop.Components.Cards
{
    partial class PaymentParkingSessionCard
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelStartDate = new Labels.PrimaryLabel();
            startDate = new Controls.TextBoxes.ReadOnlyTextBox();
            labelEndDate = new Labels.PrimaryLabel();
            endDate = new Controls.TextBoxes.ReadOnlyTextBox();
