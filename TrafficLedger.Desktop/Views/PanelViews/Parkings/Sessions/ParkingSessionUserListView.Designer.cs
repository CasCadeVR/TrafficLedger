...
{
    partial class ParkingSessionUserListView
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            checkBoxShowCompleted = new TrafficLedger.Desktop.Components.Controls.CheckBoxes.DefaultCheckBox();
            ...
            tableLayoutPanelWithActive.Controls.Add(checkBoxShowCompleted, 0, 0);
            ...
            // 
            checkBoxShowCompleted.BackColor = Color.White;
            checkBoxShowCompleted.Dock = DockStyle.Fill;
            checkBoxShowCompleted.Font = new Font("Segoe UI", 9.75F);
            checkBoxShowCompleted.ForeColor = Color.FromArgb(0, 0, 0);
            checkBoxShowCompleted.Location = new Point(4, 3);
            checkBoxShowCompleted.Margin = new Padding(4, 3, 4, 3);
            checkBoxShowCompleted.Name = "checkBoxShowCompleted";
            checkBoxShowCompleted.Size = new Size(692, 34);
            checkBoxShowCompleted.TabIndex = 1;
            checkBoxShowCompleted.Text = "Показать законченные сессии";
            checkBoxShowCompleted.UseVisualStyleBackColor = false;
            checkBoxShowCompleted.CheckedChanged += checkBoxShowCompleted_CheckedChanged;
            // 
            // ParkingSessionUserListView
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            Margin = new Padding(5, 3, 5, 3);
            Name = "ParkingSessionUserListView";
        ...
        private Components.Controls.CheckBoxes.DefaultCheckBox checkBoxShowCompleted;
    }
}
